/**
 * @api {post} /v1/task/done Mark a Task as Done
 * @apiName /v1/task/done
 * @apiGroup Task
 * @apiPermission none
 *
 * @apiDescription This will mark a task as done.
 *
 * @apiParam {String}	id	            Task ID which we are trying to mark as done.
 *
...
module.exports = async (url) => {
    app.post(url, async (req, res, next) => {
        ...
        const response = await editTask.done({ id })
